...
**Research:** I recently completed my second M.Sc. in Computer Science at the Mila AI Institute, where I explored state representation learning for deep reinforcement learning, advised by Pablo Samuel Castro. Our work together eventually led to a survey of the field published in Transactions on Machine Learning Research (TMLR). I also contributed to multi-agent reinforcement learning research at Mila, collaborating with Juan Duque under the supervision of Aaron Courville and Hugo Larochelle. Our work investigated opponent-shaping methods for improving cooperation in climate and economic multi-agent simulations, leading to a publication at ICLR 2026. Before joining Mila, I worked with Christian Ethier and his brain-computer interface research group at the CERVO Brain Research Center, where I led the development of end-to-end pipelines for decoding intracortical signals using deep learning.

**Industry:** More recently, I had the opportunity to apply AI in industry R&D at both Bombardier Aerospace and Bentley Systems. At Bombardier, I developed flight-test data pipelines and customized training pipelines for evaluating deep learning approaches to virtual sensor development. At Bentley, I explored the use of deep reinforcement learning for discrete optimization problems in civil engineering.
