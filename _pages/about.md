...
Study of opponent-shaping methods for improving cooperation in climate-economic social dilemmas through multi-agent reinforcement learning.

---

## Selected Graduate Coursework (2022-2024)

Information Theory, Combinatorial Optimization, Machine Learning, Reinforcement Learning, Representation Learning, Theoretical Principles of Deep Learning, Robot Learning, Towards AGI: Scaling, Emergence, Alignment, Design and Simulation of Intelligent Systems for Industry 4.0, 3D Perception for Autonomous Vehicles, Natural Language Processing, Bioinstrumentation and Biomedical Microsystems, and Quantum Computing.
...
### Exploration of Weight-Space Representation Learning and Forward Latent Dynamics for Parameter-Space “Warping” *(Mila, 2025)*
